...
object MarkdownCreator {
    ...
    private val commandAttributeKeyDocumentation: Map<CommandAttributeKey, String> = linkedMapOf(
        ...
        CommandAttributeKey.SEARCH_VALUE to "The contentPart that has to be searched in the enclosed block of content. The search is case-sensitive.",
        CommandAttributeKey.REPLACE_BY_EXPRESSION to "The expression accessing the model class with which the contentPart defined with the attribute ```${CommandAttributeKey.SEARCH_VALUE.keyAsString}``` is replaced.",

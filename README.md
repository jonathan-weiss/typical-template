...
dependencies {
    implementation(project("org.codeblessing.typical-template:typical-template-api:0.0.10"))
    runtimeOnly(project("org.codeblessing.typical-template:typical-template:0.0.10"))
}
// ...
```

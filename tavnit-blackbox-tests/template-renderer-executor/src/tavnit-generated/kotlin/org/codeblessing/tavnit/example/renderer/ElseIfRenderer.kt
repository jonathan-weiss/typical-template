...
/**
 * Generate the content for the template `ElseIfRenderer`.
 *
 * This template renderer was generated from the template:
 * - file: `else-if-case.html`
 * - path: `ifelse/else-if-case.html`
 */
object ElseIfRenderer : RendererWithBlackboxDefaultModel {
    ...
    override fun filePath(model: BlackboxDefaultModel): String {
      return "ifelse/else-if-case.html"
    }
}
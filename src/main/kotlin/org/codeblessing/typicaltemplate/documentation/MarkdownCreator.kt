...
object MarkdownCreator {
    ...
    private val commandKeyDocumentation: Map<CommandKey, String> = mapOf(
        CommandKey.TEMPLATE to "Defines in which template the content of the given file is put into. This command must be the first command and can only occur one time per file.",
    ...
    private val commandAttributeKeyDocumentation: Map<CommandAttributeKey, String> = mapOf(
        CommandAttributeKey.TEMPLATE_CLASS_NAME to "The name of the template class that will generate this template.",
        CommandAttributeKey.TEMPLATE_CLASS_PACKAGE_NAME to "The name of the package where the class defined with '${CommandAttributeKey.TEMPLATE_CLASS_NAME.keyAsString}' resides in.",
        ...
        CommandAttributeKey.TEMPLATE_MODEL_CLASS_PACKAGE_NAME to "The name of the package where the model class defined with '${CommandAttributeKey.TEMPLATE_MODEL_CLASS_NAME.keyAsString}' resides in.",
